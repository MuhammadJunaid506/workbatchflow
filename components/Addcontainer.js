...
import styles from '@/styles/add-container.module.css'
...
const AddContainer = ({
  ...
  return (
    <div className={styles.cardHeaderParent} style={frameDiv2Style}>
          ...
          <div className={styles.workflowCard}>
            <div className={styles.frameGroup}>
              ...
              <div className={styles.designAWebsiteParent}>
                <div className={styles.designAWebsite}>Design a website</div>
                <div className={styles.frameDiv}>
                  <div className={styles.frameChild2} style={frameDiv3Style} />
                  <div className={styles.frameInner} />
                </div>
                <div className={styles.frameParent1}>
                  <div className={styles.apicontactrmcomWrapper}>
